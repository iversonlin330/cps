...
@section('content')
 <div class="row-fluid main-padding">
	<div class="float-left">
		...
		<button type="button" class="btn btn-warning" data-toggle="modal" data-target="#orderModal">任務排序</button>
	</div>
 ...
 <div class="row-fluid main-padding">
  ...
  @for($i=0;$i<=5;$i++)
    <tr>
	  ...
	  <td><button type="button" class="btn btn-r btn-sm">刪除</button></td>
    </tr>
	@endfor
  </tbody>
</table>
